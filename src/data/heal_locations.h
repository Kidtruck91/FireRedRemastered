static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_CITY), MAP_NUM(CHERRYGROVE_CITY), 35, 7},
    [SPAWN_VIOLET_CITY - 1] = {MAP_GROUP(VIOLET_CITY), MAP_NUM(VIOLET_CITY), 31, 28},
    [SPAWN_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN), 19, 10},
    [SPAWN_ROUTE_32 - 1] = {MAP_GROUP(ROUTE32), MAP_NUM(ROUTE32), 11, 78},
    [SPAWN_GOLDENROD_CITY - 1] = {MAP_GROUP(GOLDENROD_CITY), MAP_NUM(GOLDENROD_CITY), 17, 30},
    [SPAWN_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_CITY), MAP_NUM(ECRUTEAK_CITY), 27, 29},
    [SPAWN_MOHOGANY_TOWN - 1] = {MAP_GROUP(MOHOGANY_TOWN), MAP_NUM(MOHOGANY_TOWN), 15, 18},
    [SPAWN_OLIVINE_CITY - 1] = {MAP_GROUP(OLIVINE_CITY), MAP_NUM(OLIVINE_CITY), 13, 22},
    [SPAWN_CIANWOOD_CITY - 1] = {MAP_GROUP(CIANWOOD_CITY), MAP_NUM(CIANWOOD_CITY), 16, 32},
    [SPAWN_BLACKTHORN_CITY - 1] = {MAP_GROUP(BLACKTHORN_CITY), MAP_NUM(BLACKTHORN_CITY), 22, 29},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_CHERRYGROVE_CITY - 1] = {MAP_GROUP(CHERRYGROVE_POKECENTER_1F), MAP_NUM(CHERRYGROVE_POKECENTER_1F)},
    [SPAWN_VIOLET_CITY - 1] = {MAP_GROUP(VIOLET_POKECENTER_1F), MAP_NUM(VIOLET_POKECENTER_1F)},
    [SPAWN_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_POKECENTER_1F), MAP_NUM(AZALEA_POKECENTER_1F)},
    [SPAWN_ROUTE_32 - 1] = {MAP_GROUP(ROUTE32_POKECENTER_1F), MAP_NUM(ROUTE32_POKECENTER_1F)},
    [SPAWN_GOLDENROD_CITY - 1] = {MAP_GROUP(GOLDENROD_POKECENTER_1F), MAP_NUM(GOLDENROD_POKECENTER_1F)},
    [SPAWN_ECRUTEAK_CITY - 1] = {MAP_GROUP(ECRUTEAK_POKECENTER_1F), MAP_NUM(ECRUTEAK_POKECENTER_1F)},
    [SPAWN_MOHOGANY_TOWN - 1] = {MAP_GROUP(MOHOGANY_POKECENTER_1F), MAP_NUM(MOHOGANY_POKECENTER_1F)},
    [SPAWN_OLIVINE_CITY - 1] = {MAP_GROUP(OLIVINE_POKECENTER_1F), MAP_NUM(OLIVINE_POKECENTER_1F)},
    [SPAWN_CIANWOOD_CITY - 1] = {MAP_GROUP(CIANWOOD_PHARMACY), MAP_NUM(CIANWOOD_PHARMACY)},
    [SPAWN_BLACKTHORN_CITY - 1] = {MAP_GROUP(BLACKTHORN_POKECENTER_1F), MAP_NUM(BLACKTHORN_POKECENTER_1F)},
};
