...
static void Task_DoSaleOfTMs(u8 taskId)
{
    ...
    RecordItemTransaction(gSpecialVar_ItemId, tQuantitySelected, 2);
    DestroyListMenuTask(tListTaskId, &sTMCaseStaticResources.scrollOffset, &sTMCaseStaticResources.selectedRow);
    TMCaseSetup_GetTMCount();
    TMCaseSetup_InitListMenuPositions();
    InitTMCaseListMenuItems();
...
static void DrawMoveInfoLabels(void)
{
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, 19, 0, 0);
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, 20, 0, 12);
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, 21, 0, 24);
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, 22, 0, 36);
